...
namespace FarmSimulator.Core.Properties.Dobytok
{
    ...
    public static class TypyDobytka
    {
        ...
        public static readonly TypDobytkaInfo Krava = new("krava", 800, 500, 16, false, 40, 5, 4, DruhZvierata.Krava, TypObchodnehoTovaru.Dobytok, [TypyProduktov.KravskeMlieko, TypyProduktov.Hovadzina]);
